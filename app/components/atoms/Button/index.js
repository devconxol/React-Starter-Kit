...
const hoverBackgroundColor = ({ disabled, transparent }) => !disabled && !transparent && palette(2);
const hoverForegroundColor = ({ disabled, transparent }) => !disabled && transparent && palette(2);
